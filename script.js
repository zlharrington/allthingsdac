...
applyBrandLogo();wireLegacyNavigation();wireRenderedNavigation();markCurrentPage();addMobileActionBar();improveImages();ensureCanonical();loadScript('site-content.js?v=20260817-page-editor').catch(error=>console.warn('Managed page content could not load.',error));window.allThingsReactReady=mountReactLayout();
